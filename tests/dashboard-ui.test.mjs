...
test("dashboard cache shell includes the membership resolver and has no removed UI modules", async () => {
  ...
  assert.match(worker, /ailynx-weather-v66/);
  assert.match(html, /manifest\.webmanifest\?v=2/);
  for (const asset of ["styles.css?v=35", "icons/ailynx-brand.jpg", "asset-registry.js?v=5", "manifest.webmanifest?v=2", "/api/public-runtime-config.js", "public-runtime-config.js?v=1", "community-config.js?v=4", "admin-access.js?v=2", "admin-preview.js?v=1", "admin-asset-client.js?v=1", "membership-client.js?v=2", "core-dynamics.js?v=1", "i18n.js?v=6", "member-community.js?v=5", "admin.html", "admin-page.js?v=2", "auth-gate.js?v=4", "app.js?v=52"]) {
