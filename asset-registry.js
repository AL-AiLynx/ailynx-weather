...
export const ASSET_READERS = Object.freeze({
  ...
  XAUUSD: Object.freeze({id: "XAUUSD", label: "금", tickerId: "OANDA:XAUUSD", sourceProfileCode: "OANDA_XAUUSD_CFD_V1", requiredPlan: "PLUS", priceKind: "OBSERVED"}),
  DXY: Object.freeze({id: "DXY", label: "달러 인덱스", tickerId: "CAPITALCOM:DXY", sourceProfileCode: "CAPITALCOM_DXY_CFD_V1", requiredPlan: "PREMIUM", priceKind: "OBSERVED"}),
  US100: Object.freeze({id: "US100", label: "나스닥 100", tickerId: "SKILLING:US100", sourceProfileCode: "SKILLING_US100_CFD_V1", requiredPlan: "PLUS", priceKind: "OBSERVED"}),
});
