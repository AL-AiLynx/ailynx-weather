...
const APP_SHELL = [
  ...
  "./lynx-dashboard-config.js?v=21",
  "./lynx-notices.js?v=16",
  "./asset-registry.js?v=7",
  "./asset-presentation.js?v=1",
  "./weather-symbols.js?v=1",
  "./weather-history.js?v=2",
  "./core-dynamics.js?v=1",
  "./as1-asset-client.js?v=6",
  "./asset-read-path.js?v=2",
  "./public-runtime-config.js?v=1",
  "./community-config.js?v=4",
  "./admin-access.js?v=3",
  "./admin-preview.js?v=2",
  "./admin-asset-client.js?v=1",
  "./auth-client.js?v=1",
  "./i18n.js?v=6",
  "./community-client.js?v=1",
  "./membership-client.js?v=2",
  "./member-community.js?v=5",
